...
#define AI_FLAG_DOUBLE_TRAINER          (AI_FLAG_BASIC_TRAINER | AI_FLAG_HP_AWARE | AI_FLAG_SMART_SWITCHING | AI_FLAG_WEIGH_ABILITY_PREDICTION | AI_FLAG_ASSUME_STAB | AI_FLAG_SMART_TERA)
