...
#define AI_FLAG_DOUBLE_TRAINER          (AI_FLAG_BASIC_TRAINER | AI_FLAG_HP_AWARE | AI_FLAG_SMART_SWITCHING | AI_FLAG_WEIGH_ABILITY_PREDICTION | AI_FLAG_SMART_TERA | AI_FLAG_ASSUME_STAB)
#define AI_FLAG_DOUBLE_ELITE_TRAINER    (AI_FLAG_BASIC_TRAINER | AI_FLAG_OMNISCIENT | AI_FLAG_SMART_SWITCHING | AI_FLAG_SMART_MON_CHOICES | AI_FLAG_PP_STALL_PREVENTION | AI_FLAG_SMART_TERA)
