...
#define B_FLAG_FORCE_DOUBLE_WILD    FLAG_ALWAYS_SET     // If this flag is set, all land and surfing wild battles will be double battles.
#define B_SMART_WILD_AI_FLAG        0                   // If this flag is set, wild Pokémon will become smart, with all AI flags enabled.
#define B_FLAG_NO_BAG_USE           FLAG_ALWAYS_SET     // If this flag is set, the ability to use the bag in battle is disabled.
...
#define B_FLAG_TERA_ORB_CHARGED     FLAG_ALWAYS_SET     // If this flag is set, the Tera Orb is charged. It is automatically set upon healing and cleared upon Terastallizing once configured.
#define B_FLAG_TERA_ORB_NO_COST     FLAG_ALWAYS_SET     // If this flag is set, the Tera Orb does not use up its charge upon Terastallization. In S/V, this occurs after an event with Terapagos.
